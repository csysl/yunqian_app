...
public class joinSigninActivity extends Activity {
    private Button joinSignin;
    User user;
    Course banke;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.join_signin);
        Intent intent = this.getIntent();
        user=(User)intent.getSerializableExtra("user");
        banke=(Course) intent.getSerializableExtra("banke");
        joinSignin = findViewById(R.id.participate_signin);

        joinSignin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                String param = "{\n" +
                        ...
                        "}";
                try {
                    Toast.makeText(joinSigninActivity.this, JsonParse.postJoinSignup(param), Toast.LENGTH_SHORT).show();
